    ...
    <div>
      <form>
        <div className="profileList">
          <input className="profileInput" type="file" placeholder="Avatar"></input>
          <input className="profileInput" type="email" placeholder="Email"></input>
          <input className="profileInput" type="text" placeholder="Username"></input>
          <input className="profileInput" type="text" placeholder="Location"></input>
          <input className="profileInput" type="url" placeholder="GitHub"></input>
          <input className="profileInput" type="url" placeholder="Homepage"></input>
          <input className="profileInput" type="file" placeholder="Video"></input>
        </div>
